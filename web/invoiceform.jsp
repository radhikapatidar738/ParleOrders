...
<table width="100%"  style="height:50px;background-color:lightcyan;font-family: cursive;border-radius: 70px">
    <tr align="center" >
        <td  class="tdoption"><a href="homepage.jsp">HOME</a></td>       <td class="tdoption"><a href="homepage.jsp">SIGN OUT</a></td>
    </tr>
</table>
<h1>INVOICE</h1>
...
<table   align=center style="border:double;width:300px;margin-top:50px;background-color:rgba(256,200,256,0.5)">
    ...
    <tr align="center">
        <td><img src="WebImages/invoice.webp" width="200px" height="200px"></td>
    </tr>
    <tr align="center">



<td><input type="text" name="cId" placeholder="enter customer id here"  style="width:200px;border-radius: 30px"></td>
</tr>

<tr align="center">
    
    
   <td><input type="text" name="tproduct" placeholder="write total product" style="width:200px;border-radius:30px"></td>
</tr>
<tr align="center">
    
<td><input type="cost" name="cost" placeholder="enter cost here"  style="width:200px;border-radius: 30px"></td>
</tr>
